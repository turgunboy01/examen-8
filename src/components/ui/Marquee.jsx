...
const MarqueePage = () => {
  return (
    <div className="bg-[#e5e4ed] py-[80px]">
      <div className="max-w-[1350px] mx-auto px-5 flex justify-between">
        <h2 className="text-[30px] ">Наши клиенты</h2>
      ...
      <Marquee direction="300" >
        <div className="flex gap-[30px] mx-5 pt-[30px]">
          ...
          <div className="w-[320px] h-[280px] bg-[#f8f7f3]">
            ...
            <h2 className="text-[#202020] p-4 border-t">НМИЦ онкологии им. Н.Н. Блохина</h2>
          </div>
          <div className="w-[320px] h-[280px] bg-[#f8f7f3]">
            <div className="w-full h-[220px] bg-[#fff] flex items-center justify-center">
              <img src={img2} alt="" />
